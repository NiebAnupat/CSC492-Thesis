...
ALTER TABLE "branch"
ADD FOREIGN KEY ("provice_id") REFERENCES "provice" ("provice_id") ON UPDATE CASCADE;

ALTER TABLE "branch"
ADD FOREIGN KEY ("manager_id") REFERENCES "employee" ("employee_id") ON UPDATE CASCADE;

ALTER TABLE "branch"
ADD FOREIGN KEY ("owner_account") REFERENCES "customer" ("customer_id") ON UPDATE CASCADE;
...
ALTER TABLE "employee"
ADD FOREIGN KEY ("edit_by") REFERENCES "employee" ("employee_id") ON UPDATE CASCADE;

ALTER TABLE "employee"
ADD FOREIGN KEY ("branch_id") REFERENCES "branch" ("branch_id") ON UPDATE CASCADE;

ALTER TABLE "position"
ADD FOREIGN KEY ("branch_id") REFERENCES "branch" ("branch_id") ON UPDATE CASCADE;

ALTER TABLE "dentist"
ADD FOREIGN KEY ("expert_type_id") REFERENCES "expert_type" ("expert_type_id") ON UPDATE CASCADE;
...
ALTER TABLE "dentist_workday"
ADD FOREIGN KEY ("dentist_id") REFERENCES "dentist" ("dentist_id") ON UPDATE CASCADE;
...
ADD FOREIGN KEY ("tag_id") REFERENCES "tag_list" ("tag_id") ON UPDATE CASCADE;

ALTER TABLE "patient_tag"
ADD FOREIGN KEY ("hn") REFERENCES "patient" ("hn") ON UPDATE CASCADE;
...
ADD FOREIGN KEY ("clinic_stock_id") REFERENCES "clinic_stock" ("clinic_stock_id") ON UPDATE CASCADE;
...
ADD FOREIGN KEY ("medicine_type_id") REFERENCES "medicine_type" ("medicine_type_id") ON UPDATE CASCADE;
...
ALTER TABLE "clinic_stock"
ADD FOREIGN KEY ("item_id") REFERENCES "medicine" ("medicine_id") ON UPDATE CASCADE;

ALTER TABLE "clinic_stock"
ADD FOREIGN KEY ("item_id") REFERENCES "product" ("product_id") ON UPDATE CASCADE;
...
ALTER TABLE "treatment_nv"
ADD FOREIGN KEY ("treatment_id") REFERENCES "treatment" ("treatment_id") ON UPDATE CASCADE;

ALTER TABLE "treatment_nv"
ADD FOREIGN KEY ("edit_by") REFERENCES "employee" ("employee_id") ON UPDATE CASCADE;

ALTER TABLE "treatment_nv_operation"
ADD FOREIGN KEY ("treatment_nv_id") REFERENCES "treatment_nv" ("treatment_nv_id") ON UPDATE CASCADE;

ALTER TABLE "treatment_nv_operation"
ADD FOREIGN KEY ("operation_type_id") REFERENCES "operation_type" ("operation_type_id") ON UPDATE CASCADE;

ALTER TABLE "treatment_nv_operation"
ADD FOREIGN KEY (
    "refer_denstist_expert_type_id"
) REFERENCES "expert_type" ("expert_type_id") ON UPDATE CASCADE;

ALTER TABLE "treatment_record_template"
ADD FOREIGN KEY ("create_by") REFERENCES "dentist" ("dentist_id") ON UPDATE CASCADE;

ALTER TABLE "treatment_record_edit_history"
ADD FOREIGN KEY ("treatment_id") REFERENCES "treatment" ("treatment_id") ON UPDATE CASCADE;

ALTER TABLE "treatment_record_edit_history"
ADD FOREIGN KEY ("edit_by") REFERENCES "dentist" ("dentist_id") ON UPDATE CASCADE;

ALTER TABLE "treatment_document"
ADD FOREIGN KEY ("treatment_id") REFERENCES "treatment" ("treatment_id") ON UPDATE CASCADE;

ALTER TABLE "treatment_document"
ADD FOREIGN KEY ("edit_by") REFERENCES "employee" ("employee_id") ON UPDATE CASCADE;

ALTER TABLE "treatment_operation"
ADD FOREIGN KEY ("treatment_id") REFERENCES "treatment" ("treatment_id") ON UPDATE CASCADE;

ALTER TABLE "treatment_operation"
ADD FOREIGN KEY ("operation_type_id") REFERENCES "operation_type" ("operation_type_id") ON UPDATE CASCADE;

ALTER TABLE "dispensing_medicine"
ADD FOREIGN KEY ("treatment_id") REFERENCES "treatment" ("treatment_id") ON UPDATE CASCADE;

ALTER TABLE "dispensing_medicine"
ADD FOREIGN KEY ("clinic_stock_id") REFERENCES "clinic_stock" ("clinic_stock_id") ON UPDATE CASCADE;

ALTER TABLE "lab_vender"
ADD FOREIGN KEY ("provice_id") REFERENCES "provice" ("provice_id") ON UPDATE CASCADE;
...
ALTER TABLE "lab_request"
ADD FOREIGN KEY ("vender_id") REFERENCES "lab_vender" ("vender_id") ON UPDATE CASCADE;
...
ADD FOREIGN KEY ("receipt_id") REFERENCES "receipt" ("receipt_id") ON UPDATE CASCADE;
...
ALTER TABLE "appointment"
ADD FOREIGN KEY ("nv_operation_id") REFERENCES "treatment_nv_operation" ("nv_operation_id") ON UPDATE CASCADE;
